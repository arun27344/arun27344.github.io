...
<body>
    ...
    <input type="text" name="fname" class="form-control" value=<?=$row['id']?> >    
    <label>ชื่อ:</label>
    <input type="text" name="fname" class="form-control" value=<?=$row['neme']?> > 
    <label>นามสกุล:</label>
    ...
    <input type="submit"value="๊Update" class="btn btn-success mb-4">
